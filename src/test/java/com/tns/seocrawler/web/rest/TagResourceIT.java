...
import static com.tns.seocrawler.domain.TagAsserts.*;
...
import com.tns.seocrawler.repository.TagRepository;
import com.tns.seocrawler.service.TagService;
import com.tns.seocrawler.service.dto.TagDTO;
import com.tns.seocrawler.service.mapper.TagMapper;
...
class TagResourceIT {
    ...
    public static Tag createEntity() {
        return new Tag().name(DEFAULT_NAME).slug(DEFAULT_SLUG);
    }
    ...
    public static Tag createUpdatedEntity() {
        return new Tag().name(UPDATED_NAME).slug(UPDATED_SLUG);
    }
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.name(UPDATED_NAME).slug(UPDATED_SLUG);
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.slug(UPDATED_SLUG);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).slug(UPDATED_SLUG);
