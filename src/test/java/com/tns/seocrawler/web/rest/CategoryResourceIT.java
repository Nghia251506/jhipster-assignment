...
import static com.tns.seocrawler.domain.CategoryAsserts.*;
...
import com.tns.seocrawler.repository.CategoryRepository;
import com.tns.seocrawler.service.CategoryService;
import com.tns.seocrawler.service.dto.CategoryDTO;
import com.tns.seocrawler.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    public static Category createEntity() {
        return new Category().code(DEFAULT_CODE).name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).isActive(DEFAULT_IS_ACTIVE);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().code(UPDATED_CODE).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).isActive(UPDATED_IS_ACTIVE);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.code(UPDATED_CODE).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).isActive(UPDATED_IS_ACTIVE);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.code(UPDATED_CODE).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).isActive(UPDATED_IS_ACTIVE);
