...
import com.tns.seocrawler.repository.AppUserRepository;
import com.tns.seocrawler.repository.UserRepository;
import com.tns.seocrawler.service.AppUserService;
import com.tns.seocrawler.service.dto.AppUserDTO;
import com.tns.seocrawler.service.mapper.AppUserMapper;
...
class AppUserResourceIT {
    ...
    public static AppUser createEntity() {
        return new AppUser().fullName(DEFAULT_FULL_NAME);
    }
    ...
    public static AppUser createUpdatedEntity() {
        return new AppUser().fullName(UPDATED_FULL_NAME);
    }
    ...
    void putExistingAppUser() throws Exception {
        ...
        updatedAppUser.fullName(UPDATED_FULL_NAME);
    ...
    void partialUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.fullName(UPDATED_FULL_NAME);
