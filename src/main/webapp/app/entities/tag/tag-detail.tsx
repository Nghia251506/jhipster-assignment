    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tagDetailsHeading">
          <Translate contentKey="seocrawlerApp.tag.detail.title">Tag</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="seocrawlerApp.tag.name">Name</Translate>
            </span>
          </dt>
          <dd>{tagEntity.name}</dd>
          <dt>
            <span id="slug">
              <Translate contentKey="seocrawlerApp.tag.slug">Slug</Translate>
            </span>
          </dt>
          <dd>{tagEntity.slug}</dd>
          <dt>
            <Translate contentKey="seocrawlerApp.tag.tenant">Tenant</Translate>
          </dt>
          <dd>{tagEntity.tenant ? tagEntity.tenant.code : ''}</dd>
          <dt>
            <Translate contentKey="seocrawlerApp.tag.posts">Posts</Translate>
          </dt>
          <dd>
            {tagEntity.posts
