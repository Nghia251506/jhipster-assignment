  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="seocrawlerApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="seocrawlerApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('seocrawlerApp.tag.name')}
                id="tag-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField label={translate('seocrawlerApp.tag.slug')} id="tag-slug" name="slug" data-cy="slug" type="text" />
              <ValidatedField id="tag-tenant" name="tenant" data-cy="tenant" label={translate('seocrawlerApp.tag.tenant')} type="select">
                <option value="" key="0" />
                {tenants
              ...
              <ValidatedField
                label={translate('seocrawlerApp.tag.posts')}
                id="tag-posts"
                data-cy="posts"
                type="select"
                multiple
