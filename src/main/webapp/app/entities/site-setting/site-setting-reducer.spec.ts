...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SITESETTING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SITESETTING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SITESETTING actions', async () => {
      const arg = { id: 12335 };
    ...
    it('dispatches UPDATE_SITESETTING actions', async () => {
      const arg = { id: 12335 };
    ...
    it('dispatches PARTIAL_UPDATE_SITESETTING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SITESETTING actions', async () => {
      const arg = 42666;
