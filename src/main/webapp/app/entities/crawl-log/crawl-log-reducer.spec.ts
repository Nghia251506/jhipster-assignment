...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './crawl-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRAWLLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CRAWLLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CRAWLLOG actions', async () => {
      const arg = { id: 12267 };
    ...
    it('dispatches UPDATE_CRAWLLOG actions', async () => {
      const arg = { id: 12267 };
    ...
    it('dispatches PARTIAL_UPDATE_CRAWLLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CRAWLLOG actions', async () => {
      const arg = 42666;
