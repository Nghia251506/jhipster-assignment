package com.tns.seocrawler.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.tns.seocrawler.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.tns.seocrawler.repository.UserRepository.USERS_BY_EMAIL_CACHE);
