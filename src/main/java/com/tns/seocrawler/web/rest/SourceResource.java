...
/**
 * REST controller for managing {@link com.tns.seocrawler.domain.Source}.
 */
@RestController
...
public class SourceResource {
    ...
    public ResponseEntity<List<SourceDTO>> getAllSources(
        ...
        Page<SourceDTO> page;
        if (eagerload) {
            page = sourceService.findAllWithEagerRelationships(pageable);
        } else {
            page = sourceService.findAll(pageable);
        }
